...
public class BlinkendroidVideoServerProtocol {
	...
	public BlinkendroidVideoServerProtocol(final Socket socket,
			String movieFile) throws IOException {
...
/*
        @Override
        public void run() {
        	this.setName("SRV VideoReceiverThread");
            running = true;
...
*/
		...
		public void shutdown() {
			System.out.println(" ReceiverThread shutdown start");
			running = false;
			interrupt();
			System.out.println(" ReceiverThread shutdown interrupted");
			try {
				join();
			} catch (InterruptedException e) {
				System.out.println(" ReceiverThread join failed");
				e.printStackTrace();
			}
			System.out.println(" ReceiverThread shutdown joined & end");
		}
	}
}