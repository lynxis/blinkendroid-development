...
public class ConnectionState implements CommandHandler {
	...
	/**
	 * 
	 * @param connection interface Connection which used to send packets
	 * @param socketAddr contains destination ip + port
	 * @param listener will be informed about connection state changes
	 */
